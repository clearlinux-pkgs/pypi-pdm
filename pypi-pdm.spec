...
Source0  : https://files.pythonhosted.org/packages/14/8e/505d8b7a87c7a67512788add96a93cbf26e549a1b663850beb2d06245026/pdm-2.15.0.tar.gz
...
%prep
%setup -q -n pdm-2.15.0
cd %{_builddir}/pdm-2.15.0
pushd ..
cp -a pdm-2.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713538908
