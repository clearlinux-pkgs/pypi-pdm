...
Source0  : https://files.pythonhosted.org/packages/0f/72/e61e3c7c5f1db957fffdf6ce6244597090735ebbd97ce40542c0ecfcd030/pdm-2.23.0.tar.gz
...
%prep
%setup -q -n pdm-2.23.0
cd %{_builddir}/pdm-2.23.0
pushd ..
cp -a pdm-2.23.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743517549
