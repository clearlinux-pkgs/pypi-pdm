...
Source0  : https://files.pythonhosted.org/packages/f2/b9/4d9a88a4a860ae1388c9788ee5b409733e87d93fbe6abb5bd06afbf7f00d/pdm-2.12.3.tar.gz
...
%prep
%setup -q -n pdm-2.12.3
cd %{_builddir}/pdm-2.12.3
pushd ..
cp -a pdm-2.12.3 buildavx2
popd
pushd ..
cp -a pdm-2.12.3 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707130223
