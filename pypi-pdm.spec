...
Source0  : https://files.pythonhosted.org/packages/18/df/3c775881f4c0195986581a7af29b5d5dda3e830438b542c6d556d80899f9/pdm-2.14.0.tar.gz
...
%prep
%setup -q -n pdm-2.14.0
cd %{_builddir}/pdm-2.14.0
pushd ..
cp -a pdm-2.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712937461
