...
Source0  : https://files.pythonhosted.org/packages/32/8c/ff7e0c846c573771001a207346cf6c6fb1902f2d530fb1e44d8fda0ca3c7/pdm-2.24.2.tar.gz
...
%prep
%setup -q -n pdm-2.24.2
cd %{_builddir}/pdm-2.24.2
pushd ..
cp -a pdm-2.24.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748009963
