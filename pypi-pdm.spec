...
Source0  : https://files.pythonhosted.org/packages/f1/6f/4f3c970b6c4257c3a60938e1339da3098716d72bd92845063887f7c2db3c/pdm-2.15.3.tar.gz
...
%prep
%setup -q -n pdm-2.15.3
cd %{_builddir}/pdm-2.15.3
pushd ..
cp -a pdm-2.15.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716263701
