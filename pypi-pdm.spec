...
Source0  : https://files.pythonhosted.org/packages/b3/2c/1398628d43f8ebd772eab9900616719e6910a02633e35d122a848dc393b0/pdm-2.12.2.tar.gz
...
%prep
%setup -q -n pdm-2.12.2
cd %{_builddir}/pdm-2.12.2
pushd ..
cp -a pdm-2.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705865878
