...
Source0  : https://files.pythonhosted.org/packages/f2/ca/29bfb48005d956c1f67385f9c6e134aea0a7ab298181fc82e201fa27ae78/pdm-2.24.1.tar.gz
...
%prep
%setup -q -n pdm-2.24.1
cd %{_builddir}/pdm-2.24.1
pushd ..
cp -a pdm-2.24.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745417713
