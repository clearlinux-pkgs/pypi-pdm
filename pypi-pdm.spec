...
Source0  : https://files.pythonhosted.org/packages/7f/11/4975ee5d8ca1612929e915f052358b31219516f90e43f19b69a451ba6463/pdm-2.22.2.tar.gz
...
%prep
%setup -q -n pdm-2.22.2
cd %{_builddir}/pdm-2.22.2
pushd ..
cp -a pdm-2.22.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736801252
