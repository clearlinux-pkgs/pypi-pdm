...
Source0  : https://files.pythonhosted.org/packages/2e/30/03b790c7e90d138f8e7f1703d6f30ca3e149b1ec00cf6ab6486f364b6c7c/pdm-2.12.4.tar.gz
...
%prep
%setup -q -n pdm-2.12.4
cd %{_builddir}/pdm-2.12.4
pushd ..
cp -a pdm-2.12.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708968637
