...
Source0  : https://files.pythonhosted.org/packages/af/6f/65b10a9f29e0f29955117b0126b5d424ca05826243309e07e0271f7d53a0/pdm-2.10.3.tar.gz
...
%prep
%setup -q -n pdm-2.10.3
cd %{_builddir}/pdm-2.10.3
pushd ..
cp -a pdm-2.10.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700150722
