...
Source0  : https://files.pythonhosted.org/packages/ec/e1/89c9cb77e9e3d50d2f1d7bc65b481aefe2dd28bd43722424bfeac7739536/pdm-2.16.1.tar.gz
...
%prep
%setup -q -n pdm-2.16.1
cd %{_builddir}/pdm-2.16.1
pushd ..
cp -a pdm-2.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719417756
