...
Source0  : https://files.pythonhosted.org/packages/58/fd/b081937c283502be42efdf7ae4d7c7f8014c57bd74dbc7f9b629f44d22a2/pdm-2.9.3.tar.gz
...
%prep
%setup -q -n pdm-2.9.3
cd %{_builddir}/pdm-2.9.3
pushd ..
cp -a pdm-2.9.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697322890
