...
Source0  : https://files.pythonhosted.org/packages/9c/b9/0b150ec7aae72771ece43539163892366fff3def8da6e4a512ed7b8e39c5/pdm-2.22.4.tar.gz
...
%prep
%setup -q -n pdm-2.22.4
cd %{_builddir}/pdm-2.22.4
pushd ..
cp -a pdm-2.22.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742459488
