...
Source0  : https://files.pythonhosted.org/packages/49/ad/4af216d044ac6a3dc0a5e89c801d578a246155050a1ad7b0966b1610609c/pdm-2.18.2.tar.gz
...
%prep
%setup -q -n pdm-2.18.2
cd %{_builddir}/pdm-2.18.2
pushd ..
cp -a pdm-2.18.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725966926
