...
Source0  : https://files.pythonhosted.org/packages/d9/cc/a4496763afc279f6613c614505976c09042fc97ca3e1b9b13c5a15c0fb80/pdm-2.17.3.tar.gz
...
%prep
%setup -q -n pdm-2.17.3
cd %{_builddir}/pdm-2.17.3
pushd ..
cp -a pdm-2.17.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722526928
