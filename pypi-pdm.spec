...
Source0  : https://files.pythonhosted.org/packages/ca/4f/e2a350b543e0986b2e0d76adb5db802cd86eb79ff1c4fa81bec63d342651/pdm-2.17.1.tar.gz
...
%prep
%setup -q -n pdm-2.17.1
cd %{_builddir}/pdm-2.17.1
pushd ..
cp -a pdm-2.17.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721412570
