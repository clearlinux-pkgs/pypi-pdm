...
Source0  : https://files.pythonhosted.org/packages/0c/06/c6151dbcb54d0bfebec4922c894c403b9d058066d3c663f32e5add8041dd/pdm-2.17.0.tar.gz
...
%prep
%setup -q -n pdm-2.17.0
cd %{_builddir}/pdm-2.17.0
pushd ..
cp -a pdm-2.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721318214
