...
Source0  : https://files.pythonhosted.org/packages/a7/c4/9bde4b2f83c707a556cad36e4e4a9824d75758f4e90f1bb0d0d05e2b2024/pdm-2.16.0.tar.gz
...
%prep
%setup -q -n pdm-2.16.0
cd %{_builddir}/pdm-2.16.0
pushd ..
cp -a pdm-2.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719330157
