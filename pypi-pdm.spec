...
Source0  : https://files.pythonhosted.org/packages/91/68/28a6e7e075f808e1ed751f822e074573c71ebe42b32b63efb4b8a3a0a2eb/pdm-2.20.1.tar.gz
...
%prep
%setup -q -n pdm-2.20.1
cd %{_builddir}/pdm-2.20.1
pushd ..
cp -a pdm-2.20.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731441561
